...
def get_b64_test_image_for_ryan():
...
if __name__ == '__main__':
    ...
    #print(classify_image(get_b64_test_image_for_ryan(), None))

    print(classify_image(None, "server/test_images/cilian-test2.jpg"))
    print(classify_image(None, "server/test_images/ryan-test.jpg"))
    print(classify_image(None, "server/test_images/cilian-test.jpg"))